...
class Input {
 public:
  ...
  std::tuple<float32, float32> GetCursorPosition() const noexcept;
  std::tuple<float32, float32> GetCursorScroll() const noexcept;
 ...
 private:
  ...
  mutable float32 _scrollOffsetX, _scrollOffsetY;
};
